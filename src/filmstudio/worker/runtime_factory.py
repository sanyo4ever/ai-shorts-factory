...
def build_media_adapters(settings: Settings) -> DeterministicMediaAdapters:
    return DeterministicMediaAdapters(
        ...
        wan22_python_binary=settings.wan22_python_binary,
        wan22_repo_path=settings.wan22_repo_path,
        wan22_ckpt_dir=settings.wan22_ckpt_dir,
        wan22_task=settings.wan22_task,
        wan22_size=settings.wan22_size,
        wan22_frame_num=settings.wan22_frame_num,
        wan22_sample_solver=settings.wan22_sample_solver,
        wan22_sample_steps=settings.wan22_sample_steps,
        wan22_sample_shift=settings.wan22_sample_shift,
        wan22_sample_guide_scale=settings.wan22_sample_guide_scale,
        wan22_offload_model=settings.wan22_offload_model,
        wan22_t5_cpu=settings.wan22_t5_cpu,
        wan22_convert_model_dtype=settings.wan22_convert_model_dtype,
        wan22_use_prompt_extend=settings.wan22_use_prompt_extend,
        wan22_timeout_sec=settings.wan22_timeout_sec,
        cogvideox_python_binary=settings.cogvideox_python_binary,
        cogvideox_repo_path=settings.cogvideox_repo_path,
        cogvideox_model_path=settings.cogvideox_model_path,
        cogvideox_generate_type=settings.cogvideox_generate_type,
        cogvideox_num_frames=settings.cogvideox_num_frames,
        cogvideox_num_inference_steps=settings.cogvideox_num_inference_steps,
        cogvideox_guidance_scale=settings.cogvideox_guidance_scale,
        cogvideox_width=settings.cogvideox_width,
        cogvideox_height=settings.cogvideox_height,
        cogvideox_fps=settings.cogvideox_fps,
        cogvideox_dtype=settings.cogvideox_dtype,
        cogvideox_timeout_sec=settings.cogvideox_timeout_sec,
